...
namespace lve
{
  ...
  {
    assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "Cannot create graphic pipeline:: no pipelineLayout provided in configInfo");
    assert(configInfo.renderPass != VK_NULL_HANDLE && "Cannot create graphic pipeline:: no renderPass provided in configInfo");
    ...
    {
      throw std::runtime_error("Falled to create graphics pipeline.");
    }
  }
